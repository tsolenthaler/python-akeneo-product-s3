...
S3_OBJECT_PRODUCTS_INDEX_EXPORT_PATH = getenv('S3_OBJECT_PRODUCTS_INDEX_EXPORT_PATH')

def getIndex():
    print("Get Index")
    products = getObject(S3_BUCKET, S3_OBJECT_PRODUCTS_INDEX_PATH)
    return products
...
def __main__():
    ...
    dictToS3(index, S3_BUCKET, S3_OBJECT_PRODUCTS_INDEX_EXPORT_PATH+"id.json")
